...
class Repository
{
    ...
    public function findCodesAll(...$codes): \Org\Collection\Collection
    {
        $codes = \Org\Collection\Collection::make($codes)->castString()->all();

        return new \Org\Collection\Collection(
            $this->query()
    ...
    {
        return \Org\Collection\Collection::make($models)
